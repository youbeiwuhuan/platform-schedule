package com.courage.platform.schedule.console.service.impl;
...
import com.courage.platform.schedule.console.core.util.LocalCacheUtil;
...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> add(XxlJobInfo jobInfo) {
        ...
        XxlJobInfo temp = xxlJobInfoDao.existJob(jobInfo);
        if (temp != null && temp.getId() > 0) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, ("当前JobHandler：" + jobInfo.getExecutorHandler() + "已存在"));
        }
        // add in db
