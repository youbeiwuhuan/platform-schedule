                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="radio" name="addressType" value="0"  />${I18n.jobgroup_field_addressType_0}
                                 -->
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="addressType" value="1" checked="checked" readonly/>${I18n.jobgroup_field_addressType_1}
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">${I18n.jobgroup_field_registryList}<font color="red">*</font></label>
                            <div class="col-sm-10">
                                <textarea class="textarea" name="addressList" maxlength="512" placeholder="${I18n.jobgroup_field_registryList_placeholder}" style="background-color:#eee; width: 100%; height: 100px; font-size: 14px; line-height: 10px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
