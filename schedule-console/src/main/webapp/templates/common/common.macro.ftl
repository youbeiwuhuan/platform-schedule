        ...
        statusCode: {
            999: function (data) {
                layer.open({
                    ...
                    btn: [I18n.system_ok],
                    content: (I18n.login_btn_redirect ),
                    icon: '2',
                    yes: function () {
...
<header class="main-header">
    <a href="${request.contextPath}/" class="logo">
        <span class="logo-mini"><b>HSHC</b></span>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <#--                    <li>
                                    <button type="button" class="btn  btn-lg" style="font-size:16px;margin-top: 2px;background-color: rgba(101, 0, 0, 0);color: #fff;">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu2">
                        <li role="presentation"><a role="menuitem" id="logoutBtn" tabindex="-1" href="#">${I18n.logout_btn}</a></li>
                    </ul>
                </li>
            </ul>
        </div>
