...
public class PlatformRequestTask implements Runnable {
    ...
    private final PlatformRemotingCommand request;

    private boolean stopRun = false;

    public PlatformRequestTask(final Runnable runnable, final Channel channel, final PlatformRemotingCommand request) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PlatformRequestTask)) {
            return false;
        }
        final PlatformRequestTask that = (PlatformRequestTask) o;
    ...
    public void returnResponse(int code, String remark) {
        PlatformRemotingCommand response = PlatformRemotingCommandUtils.createResponseCommand(
                code,
                remark);
